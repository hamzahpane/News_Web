...
function Sports(){
    ...
    const fecthData =  async () =>{
        ...
        let resonse =  await fetch("https://newsapi.org/v2/top-headlines?country=id&category=sports&apiKey=52449f0304f04c0aaed45cac5de1f995 ");
        
        let data =  await  resonse.json();

        setMysports(data.articles);
