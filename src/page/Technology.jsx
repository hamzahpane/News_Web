...
function Technology(){
    ...
    const[myTechnologi , setMyTechnologi] = useState([]);

    const fecthData =  async () =>{

        let resonse =  await fetch("https://newsapi.org/v2/top-headlines?country=id&category=technology&apiKey=52449f0304f04c0aaed45cac5de1f995 ");
        
        let data =  await  resonse.json();

        setMyTechnologi(data.articles);
